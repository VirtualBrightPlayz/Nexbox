...
#define API_METHOD_0_DECLARE(call, type, ret, name)
#define API_METHOD_1_DECLARE(call, type, ret, name, type0, name0)
#define API_METHOD_2_DECLARE(call, type, ret, name, type0, name0, type1, name1)
#define API_METHOD_3_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2)
#define API_METHOD_4_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3)
#define API_METHOD_5_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4)
#define API_METHOD_6_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5)
#define API_METHOD_7_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)

#define API_METHOD_RET_0_DECLARE(call, type, ret, name)
#define API_METHOD_RET_1_DECLARE(call, type, ret, name, type0, name0)
#define API_METHOD_RET_2_DECLARE(call, type, ret, name, type0, name0, type1, name1)
#define API_METHOD_RET_3_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2)
#define API_METHOD_RET_4_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3)
#define API_METHOD_RET_5_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4)
#define API_METHOD_RET_6_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5)
#define API_METHOD_RET_7_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)

#define API_OBJECT_METHOD_0_DECLARE(call, type, ret, name)
#define API_OBJECT_METHOD_1_DECLARE(call, type, ret, name, type0, name0)
#define API_OBJECT_METHOD_2_DECLARE(call, type, ret, name, type0, name0, type1, name1)
#define API_OBJECT_METHOD_3_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2)
#define API_OBJECT_METHOD_4_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3)
#define API_OBJECT_METHOD_5_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4)
#define API_OBJECT_METHOD_6_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5)
#define API_OBJECT_METHOD_7_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)

#define API_OBJECT_METHOD_RET_0_DECLARE(call, type, ret, name)
#define API_OBJECT_METHOD_RET_1_DECLARE(call, type, ret, name, type0, name0)
#define API_OBJECT_METHOD_RET_2_DECLARE(call, type, ret, name, type0, name0, type1, name1)
#define API_OBJECT_METHOD_RET_3_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2)
#define API_OBJECT_METHOD_RET_4_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3)
#define API_OBJECT_METHOD_RET_5_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4)
#define API_OBJECT_METHOD_RET_6_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5)
#define API_OBJECT_METHOD_RET_7_DECLARE(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6)

#define API_METHOD_0(call, type, ret, name) \
inline ret type##_##name() { \
    UserArgStruct args; \
     \
    call(#type "_" #name, &args); \
}
#define API_METHOD_1(call, type, ret, name, type0, name0) \
inline ret type##_##name(type0 name0) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    call(#type "_" #name, &args); \
}
#define API_METHOD_2(call, type, ret, name, type0, name0, type1, name1) \
inline ret type##_##name(type0 name0, type1 name1) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
    call(#type "_" #name, &args); \
...
#define API_METHOD_3(call, type, ret, name, type0, name0, type1, name1, type2, name2) \
inline ret type##_##name(type0 name0, type1 name1, type2 name2) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
    args.args[2] = (void*)&name2; \
...
#define API_METHOD_4(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3) \
inline ret type##_##name(type0 name0, type1 name1, type2 name2, type3 name3) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
    args.args[2] = (void*)&name2; \
...
#define API_METHOD_5(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4) \
inline ret type##_##name(type0 name0, type1 name1, type2 name2, type3 name3, type4 name4) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
    args.args[2] = (void*)&name2; \
...
#define API_METHOD_6(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5) \
inline ret type##_##name(type0 name0, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
    args.args[2] = (void*)&name2; \
...
#define API_METHOD_7(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6) \
inline ret type##_##name(type0 name0, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5, type6 name6) { \
    UserArgStruct args; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
    args.args[2] = (void*)&name2; \
...
#define API_OBJECT_METHOD_0(call, type, ret, name) \
inline ret type##_##name(type targ) { \
    UserArgStruct args; \
    args.target = targ; \
    call(#type "_" #name, &args); \
}
#define API_OBJECT_METHOD_1(call, type, ret, name, type0, name0) \
inline ret type##_##name(type targ, type0 name0) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    call(#type "_" #name, &args); \
...
#define API_OBJECT_METHOD_2(call, type, ret, name, type0, name0, type1, name1) \
inline ret type##_##name(type targ, type0 name0, type1 name1) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
...
#define API_OBJECT_METHOD_3(call, type, ret, name, type0, name0, type1, name1, type2, name2) \
inline ret type##_##name(type targ, type0 name0, type1 name1, type2 name2) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
...
#define API_OBJECT_METHOD_4(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3) \
inline ret type##_##name(type targ, type0 name0, type1 name1, type2 name2, type3 name3) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
...
#define API_OBJECT_METHOD_5(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4) \
inline ret type##_##name(type targ, type0 name0, type1 name1, type2 name2, type3 name3, type4 name4) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
...
#define API_OBJECT_METHOD_6(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5) \
inline ret type##_##name(type targ, type0 name0, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
...
#define API_OBJECT_METHOD_7(call, type, ret, name, type0, name0, type1, name1, type2, name2, type3, name3, type4, name4, type5, name5, type6, name6) \
inline ret type##_##name(type targ, type0 name0, type1 name1, type2 name2, type3 name3, type4 name4, type5 name5, type6 name6) { \
    UserArgStruct args; \
    args.target = targ; \
    args.args[0] = (void*)&name0; \
    args.args[1] = (void*)&name1; \
